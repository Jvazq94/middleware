...
#define CAMERA_HEADER
    ...
    namespace example
    {
        ...
        public:
			///\brief devuelve la proyeccion
            glm::mat4 get_projection () const
            {
                return glm::perspective (fov, ratio, near_z, far_z);
            }
			///\brief devuelve el model view
